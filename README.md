...
| [ai-act-transparency](skills/ai-act-transparency/) | Oliver Schmidt-Prietz | EU | EU AI Act Article 50 transparency assessor — which of the Art. 50(1)–(5) duties (chatbot disclosure, synthetic-content marking/watermarking, deepfake labelling, biometric notices) apply, what to implement and by when, with a mini-report and per-obligation checklist |
