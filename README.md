...
| [aws-sla-credit-check](skills/aws-sla-credit-check/) | Erin Crum | Agnostic | Analyze AWS operational incidents against AWS's published Service Level Agreements to identify potential service credit eligibility, calculate the applicable credit tier, and generate an action-item memo with claim deadlines |
