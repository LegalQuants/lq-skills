...
| [gs-classifier](skills/gs-classifier/) | Jatocao | EU | Classify goods & services into Nice classes against the EUIPO harmonised database (TMclass) — detailed and exploratory modes, bilingual ES/EN, HDB-validated terms |
