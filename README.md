...
| [enforcement-action-analysis](skills/enforcement-action-analysis/) | Andrea Ren | US | Structured, citation-backed summary of a single US enforcement document (DOJ, SEC, OFAC, BIS, FinCEN) — parties, conduct, statutory basis, penalties, and resolution for compliance and investigations work |
